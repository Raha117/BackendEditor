...
module.exports = {
  ...
  */
  sqlite: {
    client: 'sqlite3',
    connection: {
      filename: Helpers.databasePath(`${Env.get('DB_DATABASE', 'suneditor')}.mongodb`)
    },
  ...
  */
  ...
  mongodb: {
    ...
    connection: {
      ...
      username: Env.get('DB_USER', 'rahel'),
      password: Env.get('DB_PASSWORD', '123123'),
      database: Env.get('DB_DATABASE', 'suneditor'),
      options: {
